...
:warning: You should append a `#version` tag to the url (eg: `#4.0.1`) to the url below (See [Releases](../../releases))

__Authentication problems?__  See [here](../../wiki/Authenticating-NPM-with-the-Private-Github-repo)
